...
export const env = {
  ...
  DEPTH_ANYTHING3_REPO_ROOT: process.env.DEPTH_ANYTHING3_REPO_ROOT ?? "/ml_storage/ML_Models_git/Depth-Anything-3",
  DEPTH_ANYTHING3_PYTHON: process.env.DEPTH_ANYTHING3_PYTHON ?? "",
  DEPTH_ANYTHING3_TIMEOUT_MS: Number(process.env.DEPTH_ANYTHING3_TIMEOUT_MS ?? 1_800_000),
  VGGT_REPO_ROOT: process.env.VGGT_REPO_ROOT ?? "/ml_storage/ML_Models_git/vggt",
  VGGT_PYTHON: process.env.VGGT_PYTHON ?? "",
  VGGT_TIMEOUT_MS: Number(process.env.VGGT_TIMEOUT_MS ?? 1_800_000),
  ...
  STORAGE_OBJECT_READ_LIMIT: Number(process.env.STORAGE_OBJECT_READ_LIMIT ?? 2000),
  STORAGE_OBJECT_READ_WINDOW_SEC: Number(process.env.STORAGE_OBJECT_READ_WINDOW_SEC ?? 60),
